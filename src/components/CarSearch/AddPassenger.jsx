    ...
    <div className="card mb-3" style={{ width: "100%" }}>
      <div className="card-body">
        <h5 className="card-title">
          From <strong>{vehicleData.departure}</strong> to{" "}
          <strong>{vehicleData.destination}</strong>
        </h5>
        <p className="card-text">
          <b>{vacancy}</b> seat(s) in this car
        </p>
        <p className="card-text">
          Departure date: <b>{vehicleData.departure_time}</b>
        </p>
        <button
          className="btn btn-success mx-2"
          onClick={handleAddToPassenger}
          disabled={vacancy === 0}
        >
          Add one passenger
        </button>
